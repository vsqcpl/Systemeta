...
CREATE TABLE "Subtask" (
  ...
  "description" TEXT,
  "isMilestone" BOOLEAN     NOT NULL DEFAULT FALSE,
  "status"      TEXT        NOT NULL DEFAULT 'To Do' CHECK ("status" IN ('Not Started', 'To Do', 'In Progress', 'In Review', 'Done', 'Completed')),
...
CREATE TABLE "Milestone" (
  ...
  "title"     TEXT             NOT NULL,
  "date"      TEXT             NOT NULL,
  "status"      TEXT             NOT NULL DEFAULT 'upcoming' CHECK ("status" IN ('upcoming', 'pending', 'Pending', 'Invoice Generated', 'at-risk', 'at_risk', 'delayed', 'completed', 'Completed', 'paid', 'Paid', 'active', 'in-progress', 'in_progress', 'cancelled', 'on-hold', 'Not Started', 'In Progress', 'Achieved', 'achieved', 'Invoiced', 'invoiced')),
...
CREATE TABLE "Invoice" (
  ...
  "client"    TEXT             NOT NULL,
  "amount"    DOUBLE PRECISION NOT NULL CHECK ("amount" > 0),
  "status"    TEXT             NOT NULL DEFAULT 'draft' CHECK ("status" IN ('draft', 'pending', 'issued', 'partially_paid', 'paid', 'outstanding', 'overdue', 'cancelled', 'refunded')),
